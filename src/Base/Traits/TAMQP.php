...
namespace EasyApi\AMQP\Base\Traits;

use EasyApi\AMQP\Config\ConsumerConfig;
use EasyApi\AMQP\Config\ExchangeConfig;
use EasyApi\AMQP\Config\PublisherConfig;
use EasyApi\AMQP\Config\QueueConfig;
use EasyApi\AMQP\Connection\Config;
use EasyApi\AMQP\Swoole\AMQPSwooleConnection;
