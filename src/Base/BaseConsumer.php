...
namespace EasyApi\AMQP\Base;

use EasyApi\AMQP\Base\Traits\TAMQP;
use EasyApi\AMQP\Connection\Config;
use EasyApi\AMQP\Contract\IConsumer;
use EasyApi\AMQP\Contract\IMessage;
use EasyApi\AMQP\Enum\ConsumerResult;
use EasyApi\AMQP\Message;
